...
const Navbar = ({setCategory}) => {
  ...
  <div class="container-fluid">
    <a class="navbar-brand " href="#"><span className="badge bg-light text-dark fs-4">TRUENORTH</span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <div class="nav-link" style={{cursor: 'pointer'}} onClick={()=>setCategory("gand")}>Gand</div>
        </li>
      </ul>
    </div>
  </div>
